...
import { each, $, toArr } from '../lib/util'
import evalCss from '../lib/evalCss'

import style from './style.scss'
import htmlTag from './htmlTag.hbs'
import textNode from './textNode.hbs'
import htmlComment from './htmlComment.hbs'
import template from './template.hbs'

export default class Dom extends Tool {
  constructor() {
    super()
    this.name = 'dom'
    this._style = evalCss(style)
    this._isInit = false
    this._htmlTagTpl = htmlTag
    this._textNodeTpl = textNode
    this._selectedEl = document.documentElement
    this._htmlCommentTpl = htmlComment
